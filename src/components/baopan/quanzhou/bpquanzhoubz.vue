        ...
        >
            ...
            >
                ...
                <el-form-item
                    label="身份证号码："
                    class="marginb"
                    prop="teamleaderpersoncode"
                >
                    <el-input
                        placeholder="身份证号码不能为空,请去人员管理补充信息"
                        readonly
                        :disabled="true"
                        v-model="addForm.teamleaderpersoncode"
                    ></el-input>
                </el-form-item>
                <el-form-item
                    label="班组长电话："
                ...
                >
                    <el-input
                        ...
                        v-model="addForm.teamleaderphone"
                    ></el-input>
                </el-form-item>
                <el-form-item
    ...
    methods: {
        ...
        save(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    axios
                        .post('/lianxi/quanzhoureportteam', this.addForm)
                        .then((res) => {
                            if (res.data.status == 1) {
                                this.loaded = false;
                                this.addVisible = false;
        ...
        getMsg() {
            axios
                ...
                .then((res) => {
                    if (res.data.status == 1) {
                        this.addForm.teamname = res.data.content.name;
                        this.addForm.teamleaderpersoncode =
                            res.data.content.useridcode;
                        this.addForm.teamleadername = res.data.content.bzperson;
                        this.addForm.teamleaderphone = res.data.content.bzphone;
                    } else if (res.data.status == 2) {
                        this.$alert('参数错误！');
