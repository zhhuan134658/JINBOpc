            ...
            <el-table :data="baopanData" border style="width: 100%">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        >
                        <el-button
                            @click="handleKaojin(scope.$index, scope.row)"
                            type="primary"
                            plain
                            size="small"
                            >添加考勤机</el-button
            ...
            >
                ...
                <div>
                    <el-form
                        :model="kaoqinForm"
                        label-width="120px"
                        :rules="kaoqinFormRules"
                        ref="kaoqinForm"
                        label-position="right"
                    >
                        <el-form-item label="设备SN码：" prop="sbsn">
                            <el-input
                                :maxlength="20"
                                placeholder="请输入设备SN码："
                                v-model="kaoqinForm.sbsn"
                            ></el-input>
                        </el-form-item>
                        ...
                        >
                            <el-select
                                v-model="kaoqinForm.sbjinchu"
                                placeholder="请选择考勤机类型："
                            >
                                <el-option
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button @click="kaoqinFormVisible = false"
                        >取 消</el-button
                    >
                    <el-button type="primary" @click="surebangding"
                        >确 定</el-button
                    >
                </span>
            </el-dialog>
                        ...
                        <el-form-item class="marginb" prop="zhanghao">
                            ...
                            >
                                <template slot="prepend">
                                    <span style="color: red">*</span> 项目ID
                                </template>
                            </el-input>
                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        handleKaojin(index, row) {
            this.kaoqinFormVisible = true;
            this.kaoqinForm.sbsn = '';
            this.kaoqinForm.sbjinchu = '';
            console.log(row);
            this.kaoqinForm.xmid = row.xmid;
        },
        getTable() {
        ...
        surebangding() {
            // this.kaoqinxmid     xmid
            axios
                .post('/laowu_yun/ningkaoqinjixinxishangbao', this.kaoqinForm)
                .then((res) => {
                    if (res.data.status == 1) {
