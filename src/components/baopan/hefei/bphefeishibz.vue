    ...
    data() {
        ...
        return {
            ...
            bzTypeList: [
                ...
                { name: '窑炉修筑工', id: '窑炉修筑工' },
                { name: '架子工（普通架子工）', id: '架子工（普通架子工）' },
                {
                    name: '附着升降脚手架安装拆卸工',
                    id: '附着升降脚手架安装拆卸工',
                },
                { name: '高处作业吊篮操作工', id: '高处作业吊篮操作工' },
                {
                    name: '高处作业吊篮安装拆卸工',
                    id: '高处作业吊篮安装拆卸工',
                },
                ...
                { name: '通风工', id: '机械设备通风工安装工' },
                { name: '起重工（安装起重工）', id: '起重工（安装起重工）' },
                { name: '安装钳工', id: '安装钳工' },
                {
                    name: '电气设备安装工（电气安装调试工）',
                    id: '电气设备安装工（电气安装调试工）',
                },
                { name: '管工（管道工）', id: '管工（管道工）' },
                { name: '变电安装工', id: '变电安装工' },
                { name: '电工', id: '电工' },
                { name: '弱电工', id: '弱电工' },
                { name: '司泵工', id: '司泵工' },
                ...
                { name: '建筑门窗安装工', id: '建筑门窗安装工' },
                { name: '幕墙制作工', id: '建筑门窗安装工' },
                { name: '桩机操作工', id: '桩机操作工' },
                {
                    name: '建筑起重机械安装拆卸工',
                    id: '建筑起重机械安装拆卸工',
    ...
    methods: {
        ...
        save(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    axios
                        .post('/chuzhou/ShangBaoHeFeiTeam', this.addForm)
                        .then((res) => {
                            if (res.data.status == 1) {
                                this.loaded = false;
                                this.addVisible = false;
