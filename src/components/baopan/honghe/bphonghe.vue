                ...
                <div>
                    ...
                    >
                        <el-form-item class="marginb" prop="zhanghao">
                            <el-input
                                placeholder="请输入供应商key"
                                v-model="manyForm.zhanghao"
                            >
                                <template slot="prepend">
                                    <span style="color: red">*</span> 供应商key
                                </template>
                            </el-input>
                        </el-form-item>
                        <el-form-item class="marginb" prop="password">
                            <el-input
                                placeholder="请输入供应商秘钥"
                                v-model="manyForm.password"
                            >
                                <template slot="prepend">
                                    <span style="color: red">*</span> 供应商秘钥
                                </template>
                            </el-input>
                        </el-form-item>
                        <el-form-item class="marginb" prop="zongbaoname">
                            ...
                            >
                                <template slot="prepend">
                                    <span style="color: red">*</span> 项目key
                                </template>
                            </el-input>
                        </el-form-item>
                        <el-form-item class="marginb" prop="shigongcode">
                            ...
                            >
                                <template slot="prepend">
                                    <span style="color: red">*</span> 项目秘钥
                                </template>
                            </el-input>
                        </el-form-item>
                        <el-form-item>
