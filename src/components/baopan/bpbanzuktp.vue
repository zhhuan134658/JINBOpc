    ...
    <div id="bpbzktp">
        ...
        >
            ...
            >
                ...
                <el-form-item label="企业信用代码：" class="marginb">
                    <el-input
                ...
                <div style="text-align:center:color:red;">
                    当所属班组参建单位为总承包单位时，所属参见单位和企业信用代码不需要填写，如不清楚请联系管理人员
                </div>
                <el-form-item
...
export default {
    ...
    methods: {
        ...
        goback() {
            this.$router.push({ name: 'bpktp', query: { xmid: this.xmid } });
            // this.$router.go(-1);
        },
        ...
        save(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    axios
                        .post('/newbao/henankaitaipingAddteam', this.addForm)
                        .then((res) => {
                            if (res.data.status == 1) {
                                this.loaded = false;
                                this.addVisible = false;
