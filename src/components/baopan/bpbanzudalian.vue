        ...
        >
            ...
            >
                <el-form-item label="所属参建单位：" prop="bzname">
                    <el-input placeholder="请输入参建单位" readonly v-model="addForm.bzname"></el-input>
                </el-form-item>
                <el-form-item label="班组名称：" class="marginb" prop="name">
                    <el-input placeholder="请输入班组名称" readonly v-model="addForm.name"></el-input>
                </el-form-item>
                <el-form-item label="班组长姓名：" class="marginb" prop="bzperson">
                    <el-input placeholder="请输入班组长姓名" readonly v-model="addForm.bzperson"></el-input>
                </el-form-item>
                ...
                <el-form-item label="企业信用代码：" class="marginb" prop="bzcode">
                    <el-input placeholder="请输入企业信用代码" v-model="addForm.bzcode"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        goback() {
            this.$router.push({ name: 'bpdalian', query: { xmid: this.xmid } });
            // this.$router.go(-1);
        },
        ...
        save(formName) {
            ...
            this.$refs[formName].validate(valid => {
                if (valid) {
                    axios
                        .post('/laowu_yun/shangbaofujianteam', this.addForm)
                        .then(res => {
                            if (res.data.status == 1) {
                                this.loaded = false;
                                this.addVisible = false;
