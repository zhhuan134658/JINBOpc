                ...
                <div>
                    <el-form :model="manyForm" :rules="manyFormRules" ref="manyEditForm">
                        <el-form-item class="marginb" prop="zhanghao">
                            <el-input placeholder="请输入项目编号" v-model="manyForm.zhanghao">
                        ...
                        <el-form-item class="marginb" prop="zongbaoname">
                            <el-input placeholder="请输入账号" v-model="manyForm.zongbaoname">
                                <template slot="prepend">
                                    <span style="color:red">*</span> 账号(AppID)
                                </template>
                            </el-input>
                        </el-form-item>
                        <el-form-item class="marginb" prop="password">
                            <el-input placeholder="请输入密钥" v-model="manyForm.password">
                                <template slot="prepend">
                                    <span style="color:red">*</span> 密钥(SecretKey)
                                </template>
                            </el-input>
                        </el-form-item>
                        <div
