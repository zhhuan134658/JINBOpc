    ...
    <div class="imgUpload" id="mpupload">
        <div id="container">
            <a id="selectfiles" href="javascript:void(0);" class="btn">
                <el-button type="primary" plain :loading="loading" @click="loading = true">选择文件</el-button>
            </a>
        </div>
        <div><span style="color: red">*</span>可上传mp4文件</div>
                ...
                init: {
                    ...
                    FileUploaded: function (up, file, info) {
                        if (info.status == 200) {
                            ...
                            _this.videoImg(_this.licenceImg)
                            _this.loading = false
