<template>
    <div class="imgUpload" id="mpupload" style="text-align: left">
        <div id="container">
            <a id="selectfiles" href="javascript:void(0);" class="btn">
                <el-button type="primary" plain>选择文件</el-button>
            </a>
        </div>
        <!-- <div><span style="color: red">*</span>可上传jpg,png,jpeg,avi,xls,xlsx文件</div>
            ...
            uploader = new plupload.Uploader({
                ...
                filters: {
                    mime_types: [
                        ...
                        {
                            title: 'Image files',
                            extensions: 'jpg,png,jpeg,avi,xls,xlsx,docx,pdf',
                        },
                    ],
                    ...
                    FileUploaded: function (up, file, info) {
                      console.log('上传了', info)
                        if (info.status == 200) {
                            ...
                            _this.upImgList = get_uploaded_object_name(file.name);
                            console.log('上传了', _this.upImgList)
                            _this.licenceImg = hostUp + '/' + _this.upImgList;
                            console.log('准备提交给父组件', _this.licenceImg)
